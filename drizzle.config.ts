...
export default defineConfig({
	...
	dbCredentials: {
		// local postgres (mac)
		host: "lexia-aurora-psql-develop.cluster-c6dmuuo8gatt.us-east-1.rds.amazonaws.com", // Tu host remoto
		port: 5432,
		user: "postgres", // o el usuario que uses
		password: "JglaqZz7LOf78OlC5ryS", // Tu contraseña remota
		database: "postgres", // o el nombre de la base remota
		ssl: {
			rejectUnauthorized: false, // ← Permite certificados auto-firmados o no verificados
		},
